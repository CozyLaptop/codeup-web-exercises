...
var totalPrice = prompt("How much is your total price?");
var luckyNumber = Math.floor(Math.random() * 6);
alert("Your lucky number is " + luckyNumber + ". Your price before discount was " + totalPrice
 + ". And your price after the discount is " + calculateTotal(luckyNumber, totalPrice));
